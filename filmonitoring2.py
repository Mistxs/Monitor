...
logging.basicConfig(filename='490978_log.txt', level=logging.INFO, format='%(asctime)s - %(message)s')
...
def job():
    ...
    staff = [1423848, 1445307, 1445318, 1445320, 1445323, 1445333]
    ...
    for i in range(len(staff)):
        ...
        if len(dates) > 0:
            message = f"Филиал {salon_id} (OlsoSalon) Есть сломанные дни у сотрудника {staff[i]}: {dates}"
