...
logging.basicConfig(filename='520298_log.txt', level=logging.INFO, format='%(asctime)s - %(message)s')
...
def job():
    ...
    staff = [1534264, 1534265, 1534266, 1529522, 1661618]
    for i in range(len(staff)):
        ...
        if len(dates) > 0:
            message = f"Филиал {salon_id} (BeautyRoom) Есть сломанные дни у сотрудника {staff[i]}: {dates}"
